...
/// <reference types="node" />
/// <reference types="node" />
import { HttpClient } from 'deepl-node/dist/client';
import { GlossaryEntries } from 'deepl-node/dist/glossaryEntries';
import { Usage } from 'deepl-node';
import { DocumentStatus, DocumentHandle, DocumentTranslateOptions, GlossaryId, GlossaryInfo, GlossaryLanguagePair, Language, LanguageCode, SourceLanguageCode, TargetLanguageCode, TranslateTextOptions, TranslatorOptions, TextResult } from 'deepl-node/dist/types';
